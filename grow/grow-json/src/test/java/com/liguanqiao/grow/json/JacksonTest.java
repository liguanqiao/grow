...
import com.liguanqiao.grow.json.engine.jackson.JacksonEngine;
 ...
 * @since 2023/1/9
 **/
public class JacksonTest extends AbsJsonTest {

    public final JsonEngine jsonEngine = new JacksonEngine();
