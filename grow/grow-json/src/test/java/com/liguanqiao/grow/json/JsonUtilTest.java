 ...
 * @since 2023/1/9
 **/
public class JsonUtilTest extends AbsJsonTest {
    ...
    protected JsonBean json2Bean(String json) {
        return JsonUtil.toBean(json, JsonBean.class);
    }

    @Override
    protected List<JsonBean> json2GenericsBean(String json) {
        return JsonUtil.toBean(json, new JsonTypeReference<List<JsonBean>>() {
        });
    }
