...
import com.liguanqiao.grow.json.engine.hutool.HutoolEngine;
 ...
 * @since 2023/1/9
 **/
public class HutoolJsonTest extends AbsJsonTest {

    public final JsonEngine jsonEngine = new HutoolEngine();
